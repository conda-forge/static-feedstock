About static-feedstock
======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/static-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4345&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/static-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `static` can be installed with `conda`:
...
```
mamba install static
```

It is possible to list all of the versions of `static` available on your platform with `conda`:
...
```
mamba search static --channel conda-forge
```
...
mamba repoquery search static --channel conda-forge

# List packages depending on `static`:
mamba repoquery whoneeds static --channel conda-forge

# List dependencies of `static`:
mamba repoquery depends static --channel conda-forge
```
